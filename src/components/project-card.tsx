...
export default function ProjectCard({ title, description, image, github, link, tags }: ProjectCardProps) {
    const githubIcon =
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22 23" fill="none" className="icon-standard">
            ...
            <div className="flex flex-col gap-3 3xl:gap-8">
                <div className="flex flex-row justify-between items-center">
                    ...
                    <div className="flex flex-row gap-5 3xl:gap-10 4k:gap-14">
                        {link && (
                            <ClickableIcon href={link} icon={<ExternalLink className="icon-standard" />} />
                        )}
                        {github && (
                ...
                <div className="flex flex-wrap gap-2 4k:gap-4 w-full">
                    {tags.map((tag, index) => (
